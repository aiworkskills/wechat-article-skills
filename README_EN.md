...
> **When the source is not already in the product knowledge base**: a client PDF, a competitor page, an interview recording — this kit will not unpack them. Run [cue-omni-reader](https://github.com/sensedeal/cue-skills/tree/main/cue-omni-reader) to Markdown first, then your writing skills. `npx skills add sensedeal/cue-skills --skill cue-omni-reader` (MIT, not bundled).
